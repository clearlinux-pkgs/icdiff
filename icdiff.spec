...
Version  : 2.0.3
Release  : 33
URL      : https://github.com/jeffkaufman/icdiff/archive/release-2.0.3/icdiff-2.0.3.tar.gz
Source0  : https://github.com/jeffkaufman/icdiff/archive/release-2.0.3/icdiff-2.0.3.tar.gz
...
%prep
%setup -q -n icdiff-release-2.0.3
cd %{_builddir}/icdiff-release-2.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627925068
...
cp %{_builddir}/icdiff-release-2.0.3/LICENSE %{buildroot}/usr/share/package-licenses/icdiff/ee7904173585b2506078dc8dac150638f1b3e537
