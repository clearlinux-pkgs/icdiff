...
Version  : 2.0.4
Release  : 35
URL      : https://github.com/jeffkaufman/icdiff/archive/release-2.0.4/icdiff-2.0.4.tar.gz
Source0  : https://github.com/jeffkaufman/icdiff/archive/release-2.0.4/icdiff-2.0.4.tar.gz
...
%prep
%setup -q -n icdiff-release-2.0.4
cd %{_builddir}/icdiff-release-2.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628089950
...
cp %{_builddir}/icdiff-release-2.0.4/LICENSE %{buildroot}/usr/share/package-licenses/icdiff/ee7904173585b2506078dc8dac150638f1b3e537
